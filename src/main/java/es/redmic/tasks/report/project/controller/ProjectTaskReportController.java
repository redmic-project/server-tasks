package es.redmic.tasks.report.project.controller;
...
@Controller
public class ProjectTaskReportController extends ReportController {

	private final String SERVICE_NAME = "project";

	ProjectTaskReportESService service;

	@Autowired
	public ProjectTaskReportController(ProjectTaskReportESService service) {
		super(service);
